...
<style>
    ...
    .box-5-light .title { color: #222; }
    .box-5-light .subtitle { color: #555; }
    .box-5-light .number   { color: #134169; }
    ...
    .box-5-dark .title,
    .box-5-dark .number { color: #fff; }
    .box-5-dark .subtitle { color: rgba(255,255,255,0.85); }
</style>
